...
```
The `data.sql` file is located in `src/main/resources` and is used to insert dummy data into the H2 database when the sever starts, so that the sever and tests to work with prepared dummy data.
```
